  ...
  <div id="wrapper" class="clearfix">
    ...
    <header id="header" class="sticky-style-2">
      ...
      <div class="container clearfix">
        ...
        ============================================= -->
        <div id="logo">
          <a href="#" class="standard-logo">Squadcodersdev</a>
        </div><!-- #logo end -->
...
if (has_nav_menu('primary')) {
    wp_nav_menu([
        ...
        'fallback_cb' => false, //if you want to set te default menu set true
        'depth' => 4, //how many sub menus users can have,
        'walker' => new SCD_Custom_Nav_Walker(),
    ]);
}
?>
            <!-- Top Cart
